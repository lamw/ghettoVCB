...
GVCB_VIB_NAME=vghetto-ghettoVCB-8x.vib
GCVB_OFFLINE_BUNDLE_NAME=vghetto-ghettoVCB-offline-bundle-8x.zip
...
### Create ESXi 6.x/7.x Compatiable VIB
GVCB_VIB_NAME=vghetto-ghettoVCB-7x.vib
GCVB_OFFLINE_BUNDLE_NAME=vghetto-ghettoVCB-offline-bundle-7x.zip
...
# Create VIB
vibauthor -C -t ${GVCB_TEMP_DIR} -v ${GVCB_VIB_NAME} -O ${GCVB_OFFLINE_BUNDLE_NAME} -f
